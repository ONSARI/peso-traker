...
const translatedNames: Record<string, Record<string, string>> = {
    ...
    VE: { en: "Venezuela", es: "Venezuela", fr: "Venezuela", de: "Venezuela", pt: "Venezuela", ru: "Венесуэла", zh: "委内瑞拉", ar: "فنزويلا", hi: "वेनेजुएला", bn: "ভেনেজুয়েলা", it: "Venezuela", id: "Venezuela", tr: "Venezuela", ja: "ベネズエラ", yo: "Benesuẹla", ur: "وینزویلا", fa: "ونزوئلا", he: "ונצואלה" },
